@if (!env('APP_DEMO'))
    <button data-target="#revoke_module_license_modal_{{ $name }}" data-toggle="modal"
                        ...
                        <form method="post" action="{{ route('service.revoke.module') }}" accept-charset="UTF-8"
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center text-danger font-weight-bold" id="message-body">
                                    {{ __('If you revoke your license, your module data will be removed, Please take a backup of your
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        <button class="primary-btn fix-gr-bg"
                                            type="submit">{{ __('Revoke License') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        function myFunction() {
            document.getElementById('message-body').innerHTML =
                'Please wait. We are revoking your module license. Do not refresh this page or close the browser';
        }
    </script>
@else
